...
with torch.no_grad():
    ...
    for num in range(1000):
        ...
        for e in range(L):
            ...
            x_CUT8_1 = (sqrt_P.unsqueeze(1).repeat(1, N, 1, 1) @ x_CUT8.unsqueeze(-1)).squeeze(-1) + x[num, e, :].unsqueeze(0).unsqueeze(1).repeat(1, N, 1)
            ...
            x_CUT8_2 = (sqrt_P.unsqueeze(1).repeat(1, N, 1, 1) @ x_CUT8.unsqueeze(-1)).squeeze(-1) + x_pred.unsqueeze(1).repeat(1, N, 1)
